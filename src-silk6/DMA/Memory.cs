...
using eft_dma_radar.Silk6.DMA.ScatterAPI;
using eft_dma_radar.Silk6.Tarkov.GameWorld.Interactables;
using eft_dma_radar.Silk6.Tarkov.Hideout;
using eft_dma_radar.Silk6.Tarkov.Unity;
using eft_dma_radar.Silk6.Tarkov.Unity.IL2CPP;
using GameObjectManager = eft_dma_radar.Silk6.Tarkov.Unity.GOM;
using VmmSharpEx;
...
namespace eft_dma_radar.Silk6.DMA
{
    /// <summary>
    ...
    internal static class Memory
    {
        ...
        /// <summary>
        /// UnityPlayer.dll FileVersion read from the PE version resource at
        /// attach time. Empty when the probe failed (non-fatal). Used by the
        /// PhysX snapshot fingerprint so a Unity bump invalidates the cached
        /// snapshot file automatically.
        /// </summary>
        ...
        public static eft_dma_radar.Silk6.Tarkov.GameWorld.Quests.QuestManager? QuestManager => Game?.QuestManager ?? LobbyQuestReader.QuestManager;
        public static eft_dma_radar.Silk6.Tarkov.GameWorld.Profile.WishlistManager? WishlistManager => Game?.WishlistManager;
        public static eft_dma_radar.Silk6.Tarkov.GameWorld.Explosives.ExplosivesManager? Explosives => Game?.Explosives;
        public static eft_dma_radar.Silk6.Tarkov.GameWorld.Explosives.PredictedArc? InHandGrenadePrediction => Game?.Explosives?.InHandPrediction;
        public static eft_dma_radar.Silk6.Tarkov.GameWorld.Btr.BtrTracker? Btr => Game?.Btr;
        public static IReadOnlyList<eft_dma_radar.Silk6.Tarkov.GameWorld.Interactables.Switch>? Switches => Game?.Switches;
        #endregion
        ...
        private static void OnGameStarted()
        {
            ...
            eft_dma_radar.Silk6.Tarkov.QuestPlanner.QuestPlannerWorker.Start();
        ...
        private static void OnGameStopped()
        {
            ...
            eft_dma_radar.Silk6.Tarkov.QuestPlanner.QuestPlannerWorker.InvalidateCache();
        ...
        private static void RunStartupLoop()
        {
            ...
            while (!_shutdown)
            {
                try
                {
                    ...
                    eft_dma_radar.Silk6.Tarkov.Unity.IL2CPP.Il2CppDumper.Dump();
                    ...
                    uint cachedAllCamerasRva  = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.AllCameras;
                    uint cachedGomFallbackRva = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.GomFallback;
                    uint cachedCamViewMatrix  = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.Camera.ViewMatrix;
                    uint cachedCamFov         = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.Camera.FOV;
                    uint cachedCamAspect      = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.Camera.AspectRatio;
                    uint cachedCamDeref       = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.Camera.DerefIsAddedOffset;
                    uint cachedTaHier         = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.TransformAccess.HierarchyOffset;
                    uint cachedTaIdx          = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.TransformAccess.IndexOffset;
                    uint cachedThVerts        = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.TransformHierarchy.VerticesOffset;
                    uint cachedThIdx          = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.TransformHierarchy.IndicesOffset;
                    ...
                    eft_dma_radar.Silk6.Tarkov.Unity.UnityPlayerResolver.Configure(
                        new eft_dma_radar.Silk6.Tarkov.Unity.UnityPlayerResolver.HostConfig
                        {
                            Memory               = new MemoryAccessAdapter(),
                            GetLiveCamera        = () => 0UL, // silk has no LiveFpsCamera accessor; live camera dump skipped
                            ReadIl2CppClassName  = klass => eft_dma_radar.Silk6.Tarkov.Unity.Il2CppClass.ReadName(klass, useCache: true),
                            ...
                            AllCamerasRva            = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.AllCameras,
                            GomFallbackRva           = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.GomFallback,
                            CameraViewMatrix         = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.Camera.ViewMatrix,
                            CameraFov                = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.Camera.FOV,
                            CameraAspectRatio        = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.Camera.AspectRatio,
                            CameraDerefIsAddedOffset = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.Camera.DerefIsAddedOffset,
                            GoComponents             = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.GO_Components,
                            GoName                   = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.GO_Name,
                            CompObjectClass          = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.Comp_ObjectClass,
                            CompGameObject           = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.Comp_GameObject,
                            TaHierarchyOff           = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.TransformAccess.HierarchyOffset,
                            TaIndexOff               = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.TransformAccess.IndexOffset,
                            ThVertices               = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.TransformHierarchy.VerticesOffset,
                            ThIndices                = eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets.TransformHierarchy.IndicesOffset,
                    ...
                    eft_dma_radar.Silk6.Tarkov.Unity.UnityPlayerResolver.Dump();
        ...
        private static void LoadModules()
        {
            ...
            {
                Log.WriteLine($"[Memory] UnityPlayer.dll version probe failed: {ex.Message}");
            }
        ...
        /// inside the attached process, or 0 if the module isn't currently
        ...
        public static void Close()
        {
            ...
            eft_dma_radar.Silk6.Tarkov.QuestPlanner.QuestPlannerWorker.Stop();
        ...
        /// <see cref="eft_dma_radar.Silk6.Tarkov.Unity.UnityPlayerResolver"/>.
        /// </summary>
        private sealed class MemoryAccessAdapter : eft_dma_radar.Silk6.Tarkov.Unity.UnityPlayerResolver.IMemoryAccess
        {
            ...
            public void Log(string message)             => eft_dma_radar.Silk6.Misc.Log.WriteLine(message);
        }
