...
using ImGuiNET;
using Skeleton = eft_dma_radar.Silk6.Tarkov.GameWorld.Player.Skeleton;

namespace eft_dma_radar.Silk6.UI.Widgets
{
    /// <summary>
    ...
    internal static class AimviewWidget
    {
        ...
        public static void Draw()
        {
            ...
            if (pipCfg.AimviewPipSize > 0)
            {
                ...
                float sidebarW = eft_dma_radar.Silk6.UI.Shell.Sidebar.ReservedWidth;
                float rightDockW = eft_dma_radar.Silk6.UI.Shell.RightDock.ReservedWidth;
