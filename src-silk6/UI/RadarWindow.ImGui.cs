...
using eft_dma_radar.Silk6.UI.Panels;
using eft_dma_radar.Silk6.UI.Shell;
using eft_dma_radar.Silk6.UI.Widgets;
using ImGuiNET;
using Silk.NET.Maths;

namespace eft_dma_radar.Silk6.UI
{
    internal static partial class RadarWindow
    {
        ...
        private static unsafe void LoadImGuiFont(ImGuiIOPtr io)
        {
            using var stream = Assembly.GetExecutingAssembly()
                .GetManifestResourceStream("eft_dma_radar.Silk6.NeoSansStdRegular.otf");
            if (stream is null)
            {
