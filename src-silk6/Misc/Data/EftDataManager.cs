...
using System.IO;
using eft_dma_radar.Silk6.Misc.Data.TarkovMarket;

namespace eft_dma_radar.Silk6.Misc.Data
{
    /// <summary>
    ...
    internal static class EftDataManager
    {
        ...
        internal static void ModuleInit()
        {
            ...
            if (data is null)
            {
                const string resourceName = "eft_dma_radar.Silk6.DEFAULT_DATA.json";
                try
                {
