    ...
    internal static partial class SilkProgram
    {
        ...
        static void Main()
        {
            try
            {
                ...
                eft_dma_radar.Silk6.Tarkov.Features.FeatureManager.ModuleInit();
            ...
            finally
            {
                if (eft_dma_radar.Silk6.Web.WebRadarServer.IsRunning)
                    eft_dma_radar.Silk6.Web.WebRadarServer.StopAsync().GetAwaiter().GetResult();
