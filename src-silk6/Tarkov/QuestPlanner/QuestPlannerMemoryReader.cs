...
using eft_dma_radar.Silk6.Tarkov.GameWorld.Quests;
using eft_dma_radar.Silk6.Tarkov.QuestPlanner.Models;
using eft_dma_radar.Silk6.Tarkov.Unity.Collections;
using static eft_dma_radar.Silk6.Tarkov.Unity.UnityOffsets;

namespace eft_dma_radar.Silk6.Tarkov.QuestPlanner
{
    /// <summary>
