...
using eft_dma_radar.Silk6.Tarkov.GameWorld.Btr;
using eft_dma_radar.Silk6.Tarkov.GameWorld.Explosives;
...
using Switch = eft_dma_radar.Silk6.Tarkov.GameWorld.Interactables.Switch;
using VmmSharpEx;
...
namespace eft_dma_radar.Silk6.Tarkov.GameWorld
{
    ...
    internal sealed class LocalGameWorld : IDisposable
    {
        ...
        public void DumpContainersNow() => eft_dma_radar.Silk6.Tarkov.GameWorld.Loot.ContainerDumper.DumpAllContainers(this);
