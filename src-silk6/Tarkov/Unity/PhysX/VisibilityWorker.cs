...
using eft_dma_radar.Silk6.Tarkov.GameWorld;
using eft_dma_radar.Silk6.Misc;
using eft_dma_radar.Silk6.Misc.Workers;
    ...
    internal static class VisibilityWorker
    {
        ...
        private static void Tick(CancellationToken ct)
        {
            ...
            foreach (var p in gw.RegisteredPlayers)
            {
                ...
                var targetHead   = ResolveBonePosition(p, eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanHead,   EyeFallbackY);
                var targetChest  = ResolveBonePosition(p, eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanSpine3, ChestFallbackY);
                var targetPelvis = ResolveBonePosition(p, eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanPelvis, PelvisFallbackY);
        ...
        {
            var headBone = local.Skeleton?.GetBonePosition(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanHead);
        ...
        /// </summary>
        private static Vector3 ResolveBonePosition(Player p, eft_dma_radar.Silk6.Tarkov.Unity.Bones bone, float fallbackY)
        {
