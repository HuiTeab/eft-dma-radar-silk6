    ...
    internal static class CacheViewWindow
    {
            ...
            Matrix4x4 viewProj, Vector2 vpOrigin, Vector2 vpSize)
        {
            ...
            foreach (var p in gw.RegisteredPlayers)
            {
                ...
                Vector3 anchorWorld = skel.GetBonePosition(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanSpine2)
                    ?? skel.GetBonePosition(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanPelvis)
                    ?? p.Position;
            ...
            Matrix4x4 viewProj, Vector2 vpOrigin, Vector2 vpSize)
        {
            ...
            Vector2? P(eft_dma_radar.Silk6.Tarkov.Unity.Bones b)
            {
            ...
            var head    = P(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanHead);
            var neck    = P(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanNeck);
            var upper   = P(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanSpine3);
            var mid     = P(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanSpine2);
            var lower   = P(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanSpine1);
            var pelvis  = P(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanPelvis);
            var lCollar = P(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanLCollarbone);
            var rCollar = P(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanRCollarbone);
            var lElbow  = P(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanLForearm2);
            var rElbow  = P(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanRForearm2);
            var lHand   = P(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanLPalm);
            var rHand   = P(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanRPalm);
            var lKnee   = P(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanLThigh2);
            var rKnee   = P(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanRThigh2);
            var lFoot   = P(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanLFoot);
            var rFoot   = P(eft_dma_radar.Silk6.Tarkov.Unity.Bones.HumanRFoot);
        ...
        private static void DrawPlayerMarker(
            ImDrawListPtr dl,
            eft_dma_radar.Silk6.Tarkov.GameWorld.Player.Player p,
            Matrix4x4 viewProj, Vector2 vpOrigin, Vector2 vpSize)
        {
