...
namespace SDK
{
    public readonly partial struct Offsets
    {
        ...
        public readonly partial struct SynchronizableObjectLogicProcessor
        {
            ...
            // (%AppData%\eft-dma-radar-silk6\il2cpp_offsets.json) and restart to force a
        ...
        public readonly partial struct BtrController
        {
            ...
            /// Resolved via <see cref="eft_dma_radar.Silk6.Tarkov.Unity.IL2CPP.BtrControllerResolver"/>
        ...
        {
            public static ulong TypeInfoTableRva = 0x0;  // resolved at runtime via sig-scan (Unity 6 GameAssembly.dll)
